...
def resize(oldvar, oldsize, newsize, l):
	...
	l.append(('assign', newvar, oldvar, newsize-oldsize))
...
def parse_function(s, loc, toks):
	global var_constraint_dic, var_input_dic, var_size_dic
	...
	if m:
		...
		var_input_dic[newvar] = m.group(1)
		return
...
def parse_constraint(constraint):
	global var_input_dic, var_size_dic, valgrind_operations
	...
	return (var_input_dic, var_size_dic, valgrind_operations)
